...
func TestResetPassword(t *testing.T) {
	...
	if ok, userId, _ := user.ResetPassword(Phone, DeviceId, Ip, verifyCode, passwordX, log.DefaultLogger); ok != user.OK {
...
func TestChangePassword(t *testing.T) {
	...
	if ok, _ := user.ChangePassword(prevUserIdForPasswordTest, DeviceId, Ip, oldPasswordX, newPasswordX, log.DefaultLogger); ok != user.OK {
